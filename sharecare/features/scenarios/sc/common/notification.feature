# Created by ismailkoembe at 01.07.22
  ...
  @testrail-C31495 @testrail-C8844 @testrail-C8845 @testrail-C8846 @testrail-C31496 @testrail-C31497 @sanity-sc @push_notifications @common
Feature: Push Notification
  ...
  Scenario: Regular push notification for existing user
    Given I will dismiss all notification for seroney@scqa.me, Qweasdzxc1!
    Given existing user logs in with seroney@scqa.me, and Qweasdzxc1!
    #And user taps "Skip"
    When I send a regular push notification for seroney@scqa.me and Qweasdzxc1!
    Given user waits for "10" seconds
...
#    Given existing user logs in with seroney@scqa.me, and Qweasdzxc1!
##    And user taps "Skip"
#    When I send a onScreen push notification for seroney@scqa.me and Qweasdzxc1!
##    Then I should see red dot on bell icon
#
#
#
